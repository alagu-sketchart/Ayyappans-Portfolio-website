...
function setup() {
  ...
  easyB.position(width / 4, height * 1.75);
  ...
  moderateB.position(width / 2 - 45, height * 1.75);
  ...
  hardB.position(width * (3 / 4) - 55, height * 1.75);
...
function draw() {
  ...
  if (bubbleCounter == circleCount) { // if all the bubbles are popped
    playAgain.position(width / 2 - 60, height * 1.75); // button now visible
  ...
  function logoPop() { // Make the logo disappear by clicking anywhere
    image(popLogo, width / 2 + 10, height / 1.75); // displays logo image
    if (mouseIsPressed) {
  ...
  function gameReset() { // Want to play again?
    easyB.position(width / 4, height * 1.75); // show easyB
    moderateB.position(width / 2 - 45, height * 1.75); // show easyB
    hardB.position(width * (3 / 4) - 55, height * 1.75); // show easyB
